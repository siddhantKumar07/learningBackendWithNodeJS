...
// this is the schema for the interview report which will be generated by the AI model
const interviewReportSchema =z.object({
    matchScore:z.number().min(0).max(100).description("The match score between the candidate and the job description, it will be a number between 0 and 100, where 0 means the candidate is not suitable for the job and 100 means the candidate is perfect for the job"),
