 ...
 * @description This route is used to retrieve all previously generated interview reports for the authenticated user. It returns an array of reports in the response.
 * @access private
 */
